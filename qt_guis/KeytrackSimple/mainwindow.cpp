    ...
    ui(new Ui::MainWindow)
{
    ...
    _marker_detector.setMinMaxSize(0.001,0.5);
            ...
            if(_markers[i].id == 0) {
               ...
               /* QTextStream(stdout) << "ID: " << QString::number(kmarker.id) <<
                ...
                if(_serial_port->isOpen()){
                    ...
                    line.append(',');
                    line.append(QString::number(kmarker.x));
                    line.append(',');
                    line.append(QString::number(kmarker.y));
                    line.append(',');
                    line.append(QString::number(kmarker.theta));
                    line.append(',');
                    line.append("2014");
                    line.append('\n');
